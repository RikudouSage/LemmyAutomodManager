...
import {ReportRegexRepository} from "../../../entity/report-regex.entity";
...
@Component({
  selector: 'app-report-regexes-list',
  standalone: true,
  imports: [
    DataListTableComponent,
    FormatNumberPipe,
  ...
  templateUrl: './report-regexes-list.component.html',
  styleUrl: './report-regexes-list.component.scss'
})
export class ReportRegexesListComponent implements OnInit {
  ...
  constructor(
    ...
    public readonly repository: ReportRegexRepository,
  ...
  public async ngOnInit(): Promise<void> {
    this.titleService.title.set(await toPromise(this.translator.get('app.report_regexes.name')));
  }
}
