...
import {BannedUsernameRepository} from "../../../entity/banned-username.entity";
...
@Component({
  selector: 'app-banned-usernames-list',
  standalone: true,
  imports: [
    DataListTableComponent,
    FormatNumberPipe,
  ...
  templateUrl: './banned-usernames-list.component.html',
  styleUrl: './banned-usernames-list.component.scss'
})
export class BannedUsernamesListComponent implements OnInit {
  ...
  constructor(
    ...
    public readonly repository: BannedUsernameRepository,
  ...
  public async ngOnInit(): Promise<void> {
    this.titleService.title.set(await toPromise(this.translator.get('app.banned_usernames.name')));
  }
}
