...
@Component({
  selector: 'app-external-lists-list',
  standalone: true,
  imports: [
    DataListTableComponent,
    FormatNumberPipe,
  ...
  templateUrl: './external-lists-list.component.html',
  styleUrl: './external-lists-list.component.scss'
})
export class ExternalListsListComponent implements OnInit {
  ...
  constructor(
    ...
    public readonly repository: ExternalRegexListRepository,
  ...
  public async ngOnInit(): Promise<void> {
    this.titleService.title.set(await toPromise(this.translator.get('app.external_lists.name')));
  }
}
